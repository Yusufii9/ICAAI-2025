...
from ConcepPath.dassl.utils import (
    MetricMeter, AverageMeter, tolist_if_not, count_num_param, load_checkpoint,
    save_checkpoint, mkdir_if_missing, resume_from_checkpoint,
    load_pretrained_weights
)
from ConcepPath.dassl.modeling import build_head, build_backbone
from ConcepPath.dassl.evaluation import build_evaluator
...
class SimpleTrainer(TrainerBase):
    ...
    def after_epoch(self):
        ...
        if do_test and "best_val" == "best_val":
...
class TrainerX(SimpleTrainer):
    ...
    def run_epoch(self):
        ...
        for self.batch_idx, batch in enumerate(self.train_loader_x):
            ...
            meet_freq = (self.batch_idx + 1) % 2 == 0
            only_few_batches = self.num_batches < 2
